...
(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		...
		_createNavigation: function () {
			...
			var $nav_wrapper = $('<div class="nk_navWrapper"></div>').appendTo(self.$element);
			var $navContainer = $('<ul class="pogoSlider-nav"></ul>').appendTo($nav_wrapper);

			for (var i = 0;i < self.slides.length;i++) {
				$('<li data-num="' + i + '"><a class="pogoSlider-nav-btn"></a></li>').appendTo($navContainer).on('click', function () {

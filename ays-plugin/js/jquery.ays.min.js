function revslider_showDoubleJqueryError(e) {
    var t = "AYS Slider Error: You have some jquery.js library include that comes after the AYS files js include.";
    t += "<br> This includes make eliminates the AYS slider libraries, and make it not work.";
    ...
    function r(r, i) {
        if (r == t) return false;
        if (r.data("aimg") != t) {
            if (r.data("aie8") == "enabled" && f(8) || r.data("amobile") == "enabled" && Q()) r.html('<img class="nk-slider-alternative-image" src="' + r.data("aimg") + '">')
        }
        ...
        if (i.simplifyAll == "on" && (f(8) || n())) {
            r.find(".nk-caption").each(function() {
                var t = e(this);
        ...
        if (i.forceFullWidth == "on" && r.closest(".forcefullwidth_wrapper_nk_banner").length == 0) {
            var s = r.parent().offset().left;
            var l = r.parent().css("marginBottom");
            var m = r.parent().css("marginTop");
            if (l == t) l = 0;
            if (m == t) m = 0;
            r.parent().wrap('<div style="position:relative;width:100%;height:auto;margin-top:' + m + ";margin-bottom:" + l + '" class="forcefullwidth_wrapper_nk_banner"></div>');
            r.closest(".forcefullwidth_wrapper_nk_banner").append('<div class="nk-fullwidth-forcer" style="width:100%;height:' + r.height() + 'px"></div>');
            r.css({
        ...
        try {
            if (i.hideThumbsUnderResolution > e(window).width() && i.hideThumbsUnderResolution != 0) {
                r.parent().find(".nk-bullets.nk-thumbs").css({
                    display: "none"
                })
            } else {
                r.parent().find(".nk-bullets.nk-thumbs").css({
        ...
        if (!r.hasClass("revslider-initialised")) {
            ...
            var y = e.fn.jquery.split("."),
                ...
                S = parseFloat(y[2] || "0");
            if (w == 1 && E < 7) {
                r.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#992222;"> The Current Version of jQuery:' + y + " <br>Please update your Wordpress.</div>")
            }
            if (w > 1) i.ie = false;
            if (!e.support.transition) e.fn.transition = e.fn.animate;
            r.find(".caption").each(function() {
                e(this).addClass("nk-caption")
            });
            if (Q()) {
                r.find(".nk-caption").each(function() {
                    var t = e(this);
            ...
            var N = 0;
            var C = "htnk";
            if (location.protocol === "htnks:") {
                C = "htnks"
            }
            r.find(".nk-caption").each(function(n) {
                try {
            ...
            r.find(".nk-caption video").each(function(t) {
            ...
            r.append('<div class="nk-loader ' + i.spinner + '">' + '<div class="dot1"></div>' + '<div class="dot2"></div>' + '<div class="bounce1"></div>' + '<div class="bounce2"></div>' + '<div class="bounce3"></div>' + "</div>");
            if (r.find(".nk-bannertimer").length == 0) r.append('<div class="nk-bannertimer" style="visibility:hidden"></div>');
            var H = r.find(".nk-bannertimer");
            if (H.length > 0) {
                H.css({
                    width: "0%"
                })
            }
            r.addClass("nk-simpleresponsive");
            i.container = r;
            ...
            if (i.shadow != 0) {
                r.parent().append('<div class="nk-bannershadow nk-shadow' + i.shadow + '"></div>');
                var s = 0;
                if (i.forceFullWidth == "on") s = 0 - i.container.parent().offset().left;
                r.parent().find(".nk-bannershadow").css({
                    width: i.width,
                    left: s
                })
            }
            ...
            setTimeout(function() {
                r.trigger("ays_slider.slide.onloaded")
            }, 500);
            ...
            e(window).on(j, function() {
                ...
                if (e("body").find(r) != 0)
                    if (i.forceFullWidth == "on") {
                        var n = i.container.closest(".forcefullwidth_wrapper_nk_banner").offset().left;
            ...
            try {
                if (i.hideThumbsUnderResoluition != 0 && i.navigationType == "thumb") {
                    if (i.hideThumbsUnderResoluition > e(window).width()) e(".nk-bullets").css({
                        display: "none"
                    });
                    else e(".nk-bullets").css({
                        display: "block"
                    })
                }
            } catch (g) {}
            r.find(".nk-scrollbelowslider").on("click", function() {
                var t = 0;
                try {
    ...
    e.fn.extend({
        ays_slider: function(n) {
            ...
            return this.each(function() {
                if (window.nklogs == true) try {
                    console.groupCollapsed("Slider ays_slider 4.6.1 Initialisation on " + e(this).attr("id"));
                ...
                if (window.nklogs == true) try {
                    console.info("GreenSock Engine Version in Slider ays_slider:" + punchgs.TweenLite.version)
                } catch (i) {}
        ...
        revredraw: function(n) {
            return this.each(function() {
                ...
                if (n != t && n.length > 0 && e("body").find("#" + n.attr("id")).length > 0) {
                    var r = n.parent().find(".nk-bannertimer");
                    var i = r.data("opt");
                    a(n, i)
                }
            })
        ...
        revkill: function(n) {
            ...
            if (r != t && r.length > 0 && e("body").find("#" + r.attr("id")).length > 0) {
                ...
                r.trigger("ays_slider.slide.onpause");
                var i = r.parent().find(".nk-bannertimer");
                var s = i.data("opt");
                ...
                i.remove();
                try {
                    r.closest(".forcefullwidth_wrapper_nk_banner").remove()
                } catch (u) {}
                try {
        ...
        revpause: function(n) {
            return this.each(function() {
                ...
                if (n != t && n.length > 0 && e("body").find("#" + n.attr("id")).length > 0) {
                    ...
                    n.trigger("ays_slider.slide.onpause");
                    var r = n.parent().find(".nk-bannertimer");
                    var i = r.data("opt");
        ...
        revresume: function(n) {
            return this.each(function() {
                ...
                if (n != t && n.length > 0 && e("body").find("#" + n.attr("id")).length > 0) {
                    n.data("conthover", 0);
                    n.data("conthover-changed", 1);
                    n.trigger("ays_slider.slide.onresume");
                    var r = n.parent().find(".nk-bannertimer");
                    var i = r.data("opt");
        ...
        revnext: function(n) {
            return this.each(function() {
                var n = e(this);
                if (n != t && n.length > 0 && e("body").find("#" + n.attr("id")).length > 0) n.parent().find(".nk-rightarrow").click()
            })
        },
        revprev: function(n) {
            return this.each(function() {
                var n = e(this);
                if (n != t && n.length > 0 && e("body").find("#" + n.attr("id")).length > 0) n.parent().find(".nk-leftarrow").click()
            })
        },
        ...
        revshowslide: function(n) {
            return this.each(function() {
                ...
                if (r != t && r.length > 0 && e("body").find("#" + r.attr("id")).length > 0) {
                    r.data("showus", n);
                    r.parent().find(".nk-rightarrow").click()
                }
            })
        }
    });
    ...
    var a = function(n, r) {
        ...
        try {
            if (r.hideThumbsUnderResoluition != 0 && r.navigationType == "thumb") {
                if (r.hideThumbsUnderResoluition > e(window).width()) e(".nk-bullets").css({
                    display: "none"
                });
                else e(".nk-bullets").css({
                    display: "block"
        ...
        try {
            n.parent().find(".nk-bannershadow").css({
                width: r.width,
                left: o
            })
        } catch (i) {}
    ...
    var c = function(t, n) {
        ...
        if (n.navigationType == "bullet" || n.navigationType == "both") {
            t.parent().append('<div class="nk-bullets ' + r + " simplebullets " + n.navigationStyle + '"></div>')
        }
        var i = t.parent().find(".nk-bullets");
        ...
        i.append('<div class="nkclear"></div>');
        m(t, n)
    };
    var h = function(e, n) {
        function u(t) {
            e.parent().append('<div style="' + i + '" class="nk-' + t + "arrow " + s + " nkarrows " + o + '"><div class="nk-arr-allwrapper"><div class="nk-arr-iwrapper"><div class="nk-arr-imgholder"></div><div class="nk-arr-imgholder2"></div><div class="nk-arr-titleholder"></div><div class="nk-arr-subtitleholder"></div></div></div></div>')
        }
        var r = e.find(".nk-bullets");
        var i = "",
            s = "hidearrows";
        if (n.hideThumbs == 0) s = "";
        ...
        u("left");
        u("right");
        e.parent().find(".nk-rightarrow").click(function() {
            if (n.transition == 0) {
        ...
        e.parent().find(".nk-leftarrow").click(function() {
            if (n.transition == 0) {
                n.next = n.next - 1;
    ...
    var v = function(e, t) {
        var n = e.parent().find(".nk-bullets");
        var r = e.parent().find(".nkarrows");
        if (n == null) {
            e.append('<div class=".nk-bullets"></div>');
            var n = e.parent().find(".nk-bullets")
        }
        if (r == null) {
            e.append('<div class=".nkarrows"></div>');
            var r = e.parent().find(".nkarrows")
        }
    ...
    var m = function(t, n) {
        ...
        if (n.navigationType == "thumb") {
            ...
            var s = i.find(".nk-mask");
            s.width(n.thumbWidth * n.thumbAmount * n.bw);
            s.height(n.thumbHeight * n.bh);
            s.parent().width(n.thumbWidth * n.thumbAmount * n.bw);
            s.parent().height(n.thumbHeight * n.bh)
        }
        var o = r.find(".nk-leftarrow");
        var u = r.find(".nk-rightarrow");
        if (n.navigationType == "thumb" && n.navigationArrows == "nexttobullets") n.navigationArrows = "solo";
        if (n.navigationArrows == "nexttobullets") {
            o.prependTo(i).css({
                "float": "left"
            });
            u.insertBefore(i.find(".nkclear")).css({
                "float": "left"
            })
        }
        var a = 0;
    ...
    var g = function(n) {
        ...
        if (n.arr == t) {
            n.arr = r.parent().find(".nkarrows"), n.rar = r.parent().find(".nk-rightarrow"), n.lar = r.parent().find(".nk-leftarrow"), n.raimg = n.rar.find(".nk-arr-imgholder"), n.laimg = n.lar.find(".nk-arr-imgholder"), n.raimg_b = n.rar.find(".nk-arr-imgholder2"), n.laimg_b = n.lar.find(".nk-arr-imgholder2"), n.ratit = n.rar.find(".nk-arr-titleholder"), n.latit = n.lar.find(".nk-arr-titleholder")
        }
        var a = n.arr,
            f = n.rar,
            l = n.lar,
        ...
        if (f.hasClass("preview4") && !f.hasClass("hashoveralready")) {
            ...
            f.hover(function() {
                var t = e(this).find(".nk-arr-iwrapper");
                var n = e(this).find(".nk-arr-allwrapper");
    ...
    var y = function(n, r) {
        r.container.closest(".forcefullwidth_wrapper_nk_banner").find(".nk-fullwidth-forcer").css({
    ...
    var b = function(n, r) {
        n.find(".nk-caption").each(function() {
        ...
        n.find(">ul:first >li").each(function(n) {
            ...
            if (r.data("link") != t) {
                ...
                if (i == "slide") {
                    r.append('<div class="nk-caption sft slidelink" style="width:100%;height:100%;z-index:' + o + ';" data-x="center" data-y="center" data-linktoslide="' + u + '" data-start="0"><a style="width:100%;height:100%;display:block"><span style="width:100%;height:100%;display:block"></span></a></div>')
                } else {
                    u = "no";
                    r.append('<div class="nk-caption sft slidelink" style="width:100%;height:100%;z-index:' + o + ';" data-x="center" data-y="center" data-linktoslide="' + u + '" data-start="0"><a style="width:100%;height:100%;display:block" target="' + s + '" href="' + i + '"><span style="width:100%;height:100%;display:block"></span></a></div>')
                }
            }
        });
        n.parent().css({
        ...
        n.find(">ul:first >li >img").each(function(n) {
            ...
            if (r.dottedOverlay != "none" && r.dottedOverlay != t) i.closest(".slotholder").append('<div class="nk-dottedoverlay ' + r.dottedOverlay + '"></div>');
            var s = i.attr("src"),
                o = i.data("lazyload"),
                u = i.data("bgfit"),
                a = i.data("bgrepeat"),
            ...
            i.replaceWith('<div class="nk-bgimg defaultimg" data-lazyload="' + i.data("lazyload") + '" data-bgfit="' + u + '"data-bgposition="' + l + '" data-bgrepeat="' + a + '" data-lazydone="' + i.data("lazydone") + '" src="' + s + '" data-src="' + s + '" style="background-color:' + i.css("backgroundColor") + ";background-repeat:" + a + ";background-image:url(" + s + ");background-size:" + u + ";background-position:" + l + ';width:100%;height:100%;"></div>');
            if (f(8)) {
                c.find(".nk-bgimg").css({
                    backgroundImage: "none",
                    "background-image": "none"
                });
                c.find(".nk-bgimg").append('<img class="ieeightfallbackimage defaultimg" src="' + s + '" style="width:100%">')
            }
            i.css({
                opacity: 0
            });
    ...
    var k = function(e, n) {
        ...
        if (o.data("lazyload") != t && o.data("lazyload") != "undefined" && o.data("lazydone") != 1) {
            ...
            o.data("orgw", 0);
            s.data("loadeddone", 1);
            e.find(".nk-loader").css({
                display: "block"
            });
            C(e.find(".nk-static-layers"), function() {
                C(s, function() {
    ...
    var A = function(e, n) {
        e.trigger("ays_slider.slide.onbeforeswap");
        n.transition = 1;
    ...
    var O = function(n, r, i, s, o, u) {
        ...
        if (a == 16) {
            ...
            s.wrapInner('<div class="nk-half-one" style="position:relative; width:100%;height:100%"></div>');
            s.find(".nk-half-one").clone(true).appendTo(s).addClass("nk-half-two");
            s.find(".nk-half-two").removeClass("nk-half-one");
            var j = r.width;
            var F = r.height;
            if (r.autoHeight == "on") F = n.height();
            s.find(".nk-half-one .defaultimg").wrap('<div class="nk-papercut" style="width:' + j + "px;height:" + F + 'px;"></div>');
            s.find(".nk-half-two .defaultimg").wrap('<div class="nk-papercut" style="width:' + j + "px;height:" + F + 'px;"></div>');
            s.find(".nk-half-two .defaultimg").css({
                position: "absolute",
                top: "-50%"
            });
            s.find(".nk-half-two .nk-caption").wrapAll('<div style="position:absolute;top:-50%;left:0px;"></div>');
            k.add(punchgs.TweenLite.set(s.find(".nk-half-two"), {
                width: j,
                height: F,
                overflow: "hidden",
                zIndex: 15,
            ...
            k.add(punchgs.TweenLite.set(s.find(".nk-half-one"), {
                width: j,
                height: F / 2,
                overflow: "visible",
                zIndex: 10,
            ...
            k.add(punchgs.TweenLite.fromTo(s.find(".nk-half-one"), C / 800, {
                width: j,
                height: F / 2,
                position: "absolute",
                top: "0px",
            ...
            k.add(punchgs.TweenLite.fromTo(s.find(".nk-half-two"), C / 800, {
                width: j,
                height: F,
                overflow: "hidden",
                position: "absolute",
                ...
                onComplete: function() {
                    ...
                    if (s.find(".nk-half-one").length > 0) {
                        s.find(".nk-half-one .defaultimg").unwrap();
                        s.find(".nk-half-one .slotholder").unwrap()
                    }
                    s.find(".nk-half-two").remove()
                }
            }), 0);
        ...
        vt.slide = i;
        n.trigger("ays_slider.slide.onchange", vt);
        setTimeout(function() {
            n.trigger("ays_slider.slide.onafterswap")
        }, C);
        n.trigger("ays_slider.slide.onvideostop")
    };
    ...
    var _ = function(t) {
        ...
        var i = r.closest(".nk-simpleresponsive");
        var s = r.parent().data("player");
        if (t.data == YT.PlayerState.PLAYING) {
            var o = i.find(".nk-bannertimer");
            var u = o.data("opt");
            if (r.closest(".nk-caption").data("volume") == "mute") s.mute();
            u.videoplaying = true;
            i.trigger("stoptimer");
            i.trigger("ays_slider.slide.onvideoplay")
        } else {
            var o = i.find(".nk-bannertimer");
            var u = o.data("opt");
            if (t.data != -1 && t.data != 3) {
                ...
                i.trigger("ays_slider.slide.onvideostop")
            }
    ...
    var P = function(t, n) {
        var r = $f(t),
            i = e("#" + t),
            s = i.closest(".nk-simpleresponsive"),
            o = i.closest(".nk-caption");
        setTimeout(function() {
            r.addEvent("ready", function(t) {
                if (n) r.api("play");
                r.addEvent("play", function(e) {
                    var t = s.find(".nk-bannertimer");
                    var n = t.data("opt");
                    n.videoplaying = true;
                    s.trigger("stoptimer");
                ...
                r.addEvent("finish", function(e) {
                    ...
                    s.trigger("ays_slider.slide.onvideoplay");
                ...
                r.addEvent("pause", function(e) {
                    ...
                    n.videoplaying = false;
                    s.trigger("starttimer");
                    s.trigger("ays_slider.slide.onvideostop")
                });
                o.find(".nk-thumb-image").click(function() {
    ...
    var I = function(n, r, i, s) {
        ...
        var o = n.data("ctl"),
            ...
            a = 0,
            l = n.find(".nk-caption"),
            c = r.container.find(".nk-static-layers").find(".nk-caption");
        o.pause();
        ...
        l.each(function(n) {
            ...
            if (l.hasClass("nk-static-layer")) {
                ...
                if (!l.hasClass("nk-is-shown")) {
                    if (c <= r.next && h >= r.next || c == r.next || h == r.next) {
                        l.addClass("nk-is-shown");
                        o = 1
                    } else {
                        o = 0
                    }
            ...
            if (r.width < r.hideCaptionAtLimit && l.data("captionhidden") == "on") {
                ...
                if (r.width < r.hideAllCaptionAtLimit || r.width < r.hideAllCaptionAtLilmit) {
                    ...
                    l.removeClass("nk-hidden-caption")
                }
            }
            if (v == 0) {
                    ...
                    if (l.data("linktoslide") != "no") {
                        l.click(function() {
                            ...
                            if (n != "next" && n != "prev") {
                                ...
                                r.container.parent().find(".nk-rightarrow").click()
                            } else if (n == "next") r.container.parent().find(".nk-rightarrow").click();
                            else if (n == "prev") r.container.parent().find(".nk-leftarrow").click()
                        })
                    }
                }
                if (u < 0) u = 0;
                if (l.hasClass("nk-videolayer") || l.find("iframe").length > 0 || l.find("video").length > 0) {
                    ...
                    l.find("iframe").each(function() {
                        ...
                        if (l.data("videoposter") != t && l.data("videoposter").length > 2 && l.data("autoplay") != true && !s) {
                            if (l.find(".nk-thumb-image").length == 0) l.append('<div class="nk-thumb-image" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;background-image:url(' + l.data("videoposter") + '); background-size:cover"></div>');
                            else punchgs.TweenLite.set(l.find(".nk-thumb-image"), {
                                autoAlpha: 1
                            })
                        }
                                                    ...
                                                    events: {
                                                        ...
                                                        onReady: function(n) {
                                                            var r = n.target.getVideoEmbedCode(),
                                                                ...
                                                                s = i.closest(".nk-caption"),
                                                                u = s.data("videorate"),
                                                                a = s.data("videostart");
                                                            if (u != t) n.target.senklaybackRate(parseFloat(u));
                                                            if (!Q() && s.data("autoplay") == true || L) {
                                                                s.data("timerplay", setTimeout(function() {
                                                                    n.target.playVideo()
                                                                }, s.data("start")))
                                                            }
                                                            s.find(".nk-thumb-image").click(function() {
                                                                punchgs.TweenLite.to(e(this), .3, {
                                                                    autoAlpha: 0,
                                                                    force3D: "auto",
                                                                    ease: punchgs.Power3.easeInOut
                                ...
                                if (o.data("metaloaded") == 1 || i.duration != NaN) {
                                    ...
                                    if (!o.hasClass("HasListener")) {
                                        ...
                                        if (l.data("dottedoverlay") != "none" && l.data("dottedoverlay") != t)
                                            if (l.find(".nk-dottedoverlay").length != 1) o.append('<div class="nk-dottedoverlay ' + l.data("dottedoverlay") + '"></div>');
                                        if (s.attr("control") == t) {
                                            if (o.find(".nk-video-play-button").length == 0) o.append('<div class="nk-video-play-button"><i class="revicon-right-dir"></i><div class="nk-revstop"></div></div>');
                                            o.find("video, .nk-poster, .nk-video-play-button").click(function() {
                                        ...
                                        if (i.addEventListener) i.addEventListener("play", function() {
                                            ...
                                            if (l.data("videoloop") == "loopandnoslidestop") {
                                                ...
                                                r.container.trigger("ays_slider.slide.onvideostop")
                                            } else {
                                                r.videoplaying = true;
                                                r.container.trigger("stoptimer");
                                                r.container.trigger("ays_slider.slide.onvideoplay")
                                            }
                                        });
                                    ...
                                    if (o.closest(".nk-caption").data("forcecover") == 1) {
                                        H(o, r.container);
                                        o.addClass("fullcoveredvideo")
                                    }
                                    s.css({
                ...
                if (l.find("img").length > 0) {
                    ...
                    if (l.find("iframe").length > 0 || l.find("video").length > 0) {
                        ...
                        l.find(".nk-resizeme, .nk-resizeme *").each(function() {
                            U(e(this), r)
                        });
                        if (l.hasClass("nk-resizeme")) {
                ...
                if (!s) {
                    ...
                    if (l.data("splitin") == "chars" || l.data("splitin") == "words" || l.data("splitin") == "lines" || l.data("splitout") == "chars" || l.data("splitout") == "words" || l.data("splitout") == "lines") {
                        if (l.find("a").length > 0) l.data("mySplitText", new punchgs.SplitText(l.find("a"), {
                            ...
                            charsClass: "nk-splitted",
                            wordsClass: "nk-splitted",
                            linesClass: "nk-splitted"
                        }));
                        else if (l.find(".nk-layer-inner-rotation").length > 0) l.data("mySplitText", new punchgs.SplitText(l.find(".nk-layer-inner-rotation"), {
                            type: "lines,words,chars",
                            charsClass: "nk-splitted",
                            wordsClass: "nk-splitted",
                            linesClass: "nk-splitted"
        ...
        var h = e("body").find("#" + r.container.attr("id")).find(".nk-bannertimer");
        h.data("opt", r);
    ...
    var X = function(n, r) {
        var i = 0;
        var s = n.find(".nk-caption"),
            o = r.container.find(".nk-static-layers").find(".nk-caption");
        ...
        s.each(function(n) {
            var s = -1;
            var o = e(this);
            if (o.hasClass("nk-static-layer")) {
                if (o.data("startslide") == -1 || o.data("startslide") == "-1") o.data("startslide", 0);
                if (o.data("endslide") == -1 || o.data("endslide") == "-1") o.data("endslide", r.slideamount);
                if (o.hasClass("nk-is-shown")) {
                    if (o.data("startslide") > r.next || o.data("endslide") < r.next) {
                        s = 2;
                        o.removeClass("nk-is-shown")
                    } else {
                        s = 0
                    }
                } else {
    ...
    var K = function(n, r) {
        ...
        if (r.slideamount > 1 && !(r.stopAfterLoops == 0 && r.stopAtSlide == 1)) {
            var i = n.find(".nk-bannertimer");
            n.on("stoptimer", function() {
                var t = e(this).find(".nk-bannertimer");
                t.data("tween").pause();
            ...
            var s = function() {
                ...
                n.trigger("ays_slider.slide.slideatend");
                ...
                if (r.stopLoop == "on" && r.next == r.lastslidetoshow - 1) {
                    n.find(".nk-bannertimer").css({
                        visibility: "hidden"
                    });
                    n.trigger("ays_slider.slide.onstop");
                    r.noloopanymore = 1
                } else {
    ...
    var nt = function(t, n) {
        ...
        t.find(">ul:first-child >li").each(function() {
            ...
            for (var r = 1; r <= 10; r++) t.find(".rs-parallaxlevel-" + r).each(function() {
                var t = e(this);
                t.wrap('<div style="position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:' + t.css("zIndex") + '" class="nk-parallax-container" data-parallaxlevel="' + n.parallaxLevels[r - 1] + '"></div>')
            })
        });
        if (n.parallax == "mouse" || n.parallax == "scroll+mouse" || n.parallax == "mouse+scroll") {
                ...
                switch (r.type) {
                    case "mousemove":
                        var s = t.offset().top,
                            ...
                            f = u - (r.pageX - o),
                            l = a - (r.pageY - s);
                        i.find(".nk-parallax-container").each(function() {
                            var t = e(this),
            ...
            if (Q()) window.ondeviceorientation = function(n) {
                ...
                var u = 360 / t.width() * i,
                    a = 180 / t.height() * r;
                s.find(".nk-parallax-container").each(function() {
                    var t = e(this),
    ...
    var rt = function(t, n) {
        ...
        t.find(".nk-parallax-container").each(function(t) {
            var n = e(this),
    ...
    var it = function(n, r) {
        ...
        if (r.navigationType == "thumb" || r.navsecond == "both") {
            i.append('<div class="nk-bullets nk-thumbs ' + r.navigationStyle + '"><div class="nk-mask"><div class="nk-thumbcontainer"></div></div></div>')
        }
        var s = i.find(".nk-bullets.nk-thumbs .nk-mask .nk-thumbcontainer");
        var o = s.parent();
        ...
        n.find(">ul:first >li").each(function(e) {
            ...
            else var u = i.find(".defaultimg").attr("src");
    ...
    var st = function(e) {
        var t = e.parent().find(".nk-bullets.nk-thumbs .nk-mask .nk-thumbcontainer");
        var n = t.parent();
        var r = n.offset();
    ...
    var ot = function(e, t, n) {
        punchgs.TweenLite.to(e.find(".nk-thumbcontainer"), .2, {
            force3D: "auto",
            left: t,
            ease: punchgs.Power3.easeOut,
            overwrite: "auto"
